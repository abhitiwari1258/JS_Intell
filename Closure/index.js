...
console.log(count); // return increment function
count()  // count store the reference of increment function when u call count then it call inc function


// closure and high order fxn 
